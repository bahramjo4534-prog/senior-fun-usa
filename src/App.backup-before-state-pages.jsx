    ...
    <div className="app">
        ...
        <section className="hero-grid">
          <div className="hero-copy">
            ...
            <p>
              ...
              opportunities. We now include {STATE_LIST_TEXT} as the first nine states in a growing nationwide senior
              lifestyle directory.
            </p>
          ...
          <div className="hero-side">
            ...
            <div className="stats-card">
              ...
              <div className="stats-grid">
                ...
                <div>
                  <strong>{stats.maineListings}</strong>
      ...
      <main>
        <section className="section intro" id="about">
          ...
          <p>
            ...
            Senior Fun network. This version uses verified listings from official or trusted sources and is designed to
            grow into a larger national directory over time.
          </p>
        </section>
      ...
      <section className="section state-seo-section">
        ...
        <div className="state-seo-grid">
          <StateSeoCard
            title="Massachusetts senior resources"
            label="Massachusetts"
            image="/images/states/massachusetts.jpg"
            text="Browse Massachusetts senior centers, community programs, transportation options, recreational activities, cultural opportunities, caregiver resources, and senior travel ideas across Newton, Boston, Cambridge, Worcester, Springfield, Lowell, Quincy, and more."
            onClick={() => showStateListings("Massachusetts")}
          />

          <StateSeoCard
            title="Florida senior resources"
            label="Florida"
            image="/images/states/florida.jpg"
            text="Explore Florida senior centers, senior transportation help, activity programs, caregiver support, recreation centers, social events, accessible services, and senior travel resources across Miami, Orlando, Tampa, Sarasota, Jacksonville, Fort Lauderdale, and more."
            onClick={() => showStateListings("Florida")}
          />

          <StateSeoCard
            title="New York senior resources"
            label="New York"
            image="/images/states/new-york.jpg"
            text="Explore New York senior centers, older adult programs, transportation help, caregiver resources, museums, cultural opportunities, senior activities, and travel-friendly resources across New York City, Rochester, Buffalo, Syracuse, Albany, and more."
            onClick={() => showStateListings("New York")}
          />

          <StateSeoCard
            title="California senior resources"
            label="California"
            image="/images/states/california.jpg"
            text="Explore California senior centers, older adult programs, transportation help, caregiver resources, museums, cultural opportunities, senior activities, and travel-friendly resources across Los Angeles, San Francisco, San Diego, San José, Sacramento, and more."
            onClick={() => showStateListings("California")}
          />

          <StateSeoCard
            title="Texas senior resources"
            label="Texas"
            image="/images/states/texas.jpg"
            text="Explore Texas senior centers, older adult programs, transportation help, caregiver resources, nutrition programs, wellness programs, social activities, and aging services across Houston, Austin, Dallas, San Antonio, Fort Worth, El Paso, and more."
            onClick={() => showStateListings("Texas")}
          />

          <StateSeoCard
            title="Pennsylvania senior resources"
            label="Pennsylvania"
            image="/images/states/pennsylvania.jpg"
            text="Explore Pennsylvania senior centers, Area Agencies on Aging, caregiver resources, transportation help, active adult centers, museums, wellness programs, meals, and social activities across Philadelphia, Pittsburgh, Harrisburg, Lancaster, Erie, and more."
            onClick={() => showStateListings("Pennsylvania")}
          />

          <StateSeoCard
            title="Maine senior resources and travel"
            label="Maine coast"
            image="/images/states/maine.jpg"
            text="Explore Maine senior centers, Area Agencies on Aging, caregiver resources, transportation help, museums, coastal day trips, senior discounts, senior travel ideas, and scenic activities across Portland, Bar Harbor, Bangor, Augusta, Rockland, Camden, Bath, Boothbay, and more."
            onClick={() => showStateListings("Maine")}
          />

          <StateSeoCard
            title="Washington senior resources and travel"
            label="Washington"
            image="/images/states/washington.jpg"
            text="Explore Washington senior centers, Area Agencies on Aging, caregiver resources, transportation help, museums, ferry routes, scenic day trips, senior discounts, and community activities across Seattle, Tacoma, Spokane, Bellevue, Olympia, Vancouver, Bellingham, and more."
            onClick={() => showStateListings("Washington")}
          />

          <StateSeoCard
            title="Hawaii senior resources and travel"
            label="Hawaii islands"
            image="/images/states/hawaii.jpg"
            text="Explore Hawaii senior centers, caregiver support, transportation help, museums, gardens, beach parks, national parks, cultural attractions, scenic day trips, and senior-friendly travel ideas across Oahu, Maui, Kauai, Hawaii Island, Molokai, and Lanai."
            onClick={() => showStateListings("Hawaii")}
          />
      ...
      <section className="travel-routes-section">
        ...
        <p className="travel-routes-intro">
          Senior Fun USA now includes Hawaii resources and travel ideas across Oahu, Maui, Kauai, Hawaii Island,
          Molokai, and Lanai. These listings can help older adults, families, caregivers, and travel groups find gardens,
          museums, scenic stops, transportation options, caregiver resources, and slower-paced island activities.
        </p>
