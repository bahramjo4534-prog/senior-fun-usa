        ...
        <div className="state-seo-grid">
          <article className="state-seo-card">
            ...
            <p>
              ...
              cultural opportunities, caregiver resources, and senior travel ideas across Newton, Boston, Cambridge,
          ...
          <article className="state-seo-card">
            ...
            <p>
              ...
              Tampa, Sarasota, Jacksonville, Fort Lauderdale, and more.
            </p>
          ...
          <article className="state-seo-card">
            ...
            <p>
              ...
              cultural opportunities, senior activities, and travel-friendly resources across New York City, Rochester,
              Buffalo, Syracuse, Albany, and more.
            </p>
          ...
          <article className="state-seo-card">
            ...
            <p>
              ...
              cultural opportunities, senior activities, and travel-friendly resources across Los Angeles, San Francisco,
              San Diego, San José, Sacramento, and more.
            </p>
          ...
          <article className="state-seo-card">
            ...
            <p>
              ...
              programs, wellness programs, social activities, and aging services across Houston, Austin, Dallas, San
              Antonio, Fort Worth, El Paso, and more.
            </p>
          ...
          <article className="state-seo-card">
            ...
            <p>
              ...
              active adult centers, museums, wellness programs, meals, and social activities across Philadelphia,
              Pittsburgh, Harrisburg, Lancaster, Erie, and more.
            </p>
          ...
          <article className="state-seo-card">
            ...
            <p>
              ...
              Harbor, Bangor, Augusta, Rockland, Camden, Bath, Boothbay, and more.
            </p>
          ...
          <article className="state-seo-card">
            ...
            <p>
              ...
              museums, ferry routes, scenic day trips, senior discounts, and community activities across Seattle, Tacoma,
              Spokane, Bellevue, Olympia, Vancouver, Bellingham, and more.
            </p>
          ...
          <article className="state-seo-card">
            <h3>Hawaii senior resources and travel</h3>
            <p>
              Explore Hawaii senior centers, caregiver support, transportation help, museums, gardens, beach parks,
              national parks, cultural attractions, scenic day trips, and senior-friendly travel ideas across Oahu, Maui,
              Kauai, Hawaii Island, Molokai, and Lanai.
            </p>
